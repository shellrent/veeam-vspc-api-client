...
class CreateBackupServerScheduledUpgradePayload extends AbstractJsonPayload {
	...
	public function useConfiguration(CreateBackupServerUpgradePayload $payload): self {
