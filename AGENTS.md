...
Questa libreria PHP fornisce un SDK per le API della Veeam Service Provider Console (VSPC) versione 9.2 Il file OpenAPI ufficiale è disponibile in `openapi/3.6/vspc-api.json` ed è la fonte di verità per rotta, parametri e modelli di payload.
